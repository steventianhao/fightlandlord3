...
pattern_pair2_test()->
	...
	?assert(fll3:is_valid(SL,F3)),
	CL=fll3:strlist2cards(SL,F3),
	?assertMatch(rocket,fll3:pattern(CL)).
...
pattern_triple1_test()->
	...
	?assert(fll3:is_valid(SL,F3)),
	CL=fll3:strlist2cards(SL,F3),
	?assertMatch({triple,{card,_,{three,"3",3}}},fll3:pattern(CL)).
...
pattern_triple2_test()->
	...
	?assert(fll3:is_valid(SL,F3)),
	CL=fll3:strlist2cards(SL,F3),
	?assertMatch({triple_plus_single,{card,_,{three,"3",3}}},fll3:pattern(CL)).
...
pattern_triple4_test()->
	...
	?assert(fll3:is_valid(SL,F3)),
	CL=fll3:strlist2cards(SL,F3),
	?assertMatch({triple_plus_pair,{card,_,{three,"3",3}}},fll3:pattern(CL)).
...
pattern_triple7_test()->
	...
	?assert(fll3:is_valid(SL,F3)),
	CL=fll3:strlist2cards(SL,F3),
	?assertMatch({triple_straight,{card,_,{four,"4",4}}},fll3:pattern(CL)).
...
pattern_triple8_test()->
	...
	?assert(fll3:is_valid(SL,F3)),
	CL=fll3:strlist2cards(SL,F3),
	?assertMatch({triple_straight_singles,{card,_,{four,"4",4}}},fll3:pattern(CL)).	
...
pattern_triple10_test()->
	...
	?assert(fll3:is_valid(SL,F3)),
	CL=fll3:strlist2cards(SL,F3),
	?assertMatch({triple_straight_pairs,{card,_,{four,"4",4}}},fll3:pattern(CL)).
...
pattern_triple11_test()->
	...
	?assert(fll3:is_valid(SL,F3)),
	CL=fll3:strlist2cards(SL,F3),
	?assertMatch({triple_straight_singles,{card,_,{five,"5",5}}},fll3:pattern(CL)).	
...
pattern_quad3_test()->
	...
	?assert(fll3:is_valid(SL,F3)),
	CL=fll3:strlist2cards(SL,F3),
	?assertMatch({quad_plus_singles,{card,_,{three,"3",3}}},fll3:pattern(CL)).
...
pattern_quad4_test()->
	...
	?assert(fll3:is_valid(SL,F3)),
	CL=fll3:strlist2cards(SL,F3),
	?assertMatch({quad_plus_pairs,{card,_,{three,"3",3}}},fll3:pattern(CL)).
...
pattern_quad5_test()->
	...
	?assert(fll3:is_valid(SL,F3)),
	CL=fll3:strlist2cards(SL,F3),
	?assertMatch({bomb,{card,_,{three,"3",3}}},fll3:pattern(CL)).
...
pattern_single_test()->
	...
	?assert(fll3:is_valid(SL,F3)),
	CL=fll3:strlist2cards(SL,F3),
	?assertMatch({single,{card,_,{three,"3",3}}},fll3:pattern(CL)).
...
pattern_single1_test()->
	...
	?assert(fll3:is_valid(SL,F3)),
	CL=fll3:strlist2cards(SL,F3),
	?assertMatch({straight,{card,_,{seven,"7",7}}},fll3:pattern(CL)).
